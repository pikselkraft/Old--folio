...
<html prefix="og: http://ogp.me/ns#">
	...
	<head>
		<title>Derek Salmon Communication Digitale : Social Wall</title>
		<meta charset="UTF-8">
		<meta name="description" content="Derek Salmon, Communication Digitale - Développement Web à Strasbourg - Freelance. Social Wall." />
    ...
    <meta property="og:locale" content="fr_FR" />
		...
		<meta property="og:title" content="Derek Salmon Communication Digitale : Social Wall<" />
		...
		<meta name="twitter:title" content="Derek Salmon Communication Digitale : Social Wall<" />
	...
	<body>
		<!-- Header -->
			...
			<!-- Logo -->
				<h1 id="logo"><a href="index.php">Derek Salmon - Freelance Communication Digitale</a></h1>
				<!-- Nav -->
					<nav id="nav">
						<ul>
		...
		<!-- Intro -->
			<section id="two" class="main style2 left dark fullscreen">
				<div class="content box style2">
					<header>
						<h2><span itemprop="name">Communication sur les réseaux sociaux</span></h2>
					</header>
				</div>
				<script type="text/javascript" class="rebelmouse-embed-script" src="https://www.rebelmouse.com/static/js-build/embed/embed.js?site=WtoD&height=1500&flexible=1&dont_load_new_posts=0&more_button=0&show_rebelnav=1"></script>
			</section>
			...
			<section id="contact" class="main style3 secondary">
				<div class="content container">
					<header>
						<h2>Contactez-moi pour votre communication digitale</h2>
					</header>
