...
<html prefix="og: http://ogp.me/ns#">
	<head>
		<title>Derek Salmon Communication Digitale : Mes services</title>
		<meta charset="UTF-8">
		<meta name="description" content="Derek Salmon, Communication Digitale - Développement Web à Strasbourg - Site internet, référencement, webmarketing - Freelance." />
	...
	<body>
		<!-- Header -->
			<header id="header">
				<!-- Logo -->
				<h1 id="logo"><a href="index.php">Derek Salmon - Freelance Strasbourg</a></h1>
				<!-- Nav -->
					<nav id="nav">
						<ul>
							<li><a href="index.php"> &#8592; Page Présentation</a></li>
							<li><a href="social-wall.php"> Social Wall &#8594; </a></li>
						</ul>
					</nav>
			</header>
			
		<!-- Intro -->
			<section id="intro" class="main style2 dark fullscreen">
					<div class="content box style2">
						<header>
								<h2>Création de sites vitrines responsive</h2>
						</header>
							<ul>
								<li>| Site statique : HTML5 - CSS3 - Javascript</li>
								<li>| Site dynamique : CMS Wordpress</li>
								<li>| Site statique dynamique : CMS GetKirby</li>
							</ul>
					</div>
					<a href="#two" class="button style2 down anchored">More</a>
				</div>
			</section>
		...
		<!-- One -->
			<section id="two" class="main style2 left dark fullscreen">
				<div class="content box style2">
					...
					<ul>
						<li>| Audit de site web (référencement, ergonomie et qualité du code)</li>
						<li>| Référencement naturel : keywords, backlinks, trafic, rank, etc.</li>
						<li>| Référencement payant : adwords, affiliation, etc.</li>
					</ul>
				</div>
			...
			<section id="one" class="main style2 right dark fullscreen">
				<div class="content box style2">
					...
					<ul>
						...
						<li>| Webmarketing : google analytics, mailing, etc.</li>
